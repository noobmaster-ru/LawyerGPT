...
-Верни ТОЛЬКО валидный JSON без дополнительного текста, строго с такими ключами:
{
  "summarize": "<релевантный текст из статьи или сообщение об отсутствии информации>",
  "estimation": <число 0, 2 или 4>
}
